...
\x1b[38;5;208m╔══════════════════════════════════════════╗
\x1b[38;5;208m║ Creator  : ALAMGIR             ║
\x1b[38;5;208m║ Phone namber   : +8801712034653║
\x1b[38;5;208m║ Telegram : https://m.me/Tera.Papa.Alamgir.441║
\x1b[38;5;208m║ Version  : Meta 8.0                         ║
\x1b[38;5;208m║ FILENAME : ALAMGIR  FUCK PRIYA                      ║
\x1b[38;5;208m╚══════════════════════════════════════════╝
"""%(kk))
...
def menu(my_name):
	...
	print("""%s ════════════════════════════════════════════════════════ """%(h))
	print("""%s \33[m[01] \33[1;33mPublic Clone """%(h))
	print("""%s \33[m[02] \33[1;33mALAMGIR CRACK """%(h))
	print("""%s \33[m[03] \33[1;33mALAMGIR CP """%(h))
	print("""%s \33[m[00] \33[mLOG-OUT-ALAMGIR"""%(h))
	print("""%s ════════════════════════════════════════════════════════ """%(h))
...
def dump_massal():
	...
	print("""%s ════════════════════════════════════════════════════════ """%(h))
	print(x+'\33[m[ ! ] \33[1;96mselected list public option [ limit 15 ]')
	try:
		jum = int(input(x+'\33[m[ ? ] \33[1;96mselected list public ? '))
	except ValueError:
	...
	for met in range(jum):
		yz+=1
		kl = input(x+'\33[m[ ? ] \33[1;96m•selected public link '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
...
def setting():
	print("""%s ════════════════════════════════════════════════════════ """%(h))
	print("""%s \33[m[01] \33[1;32mOld id Alamgir"""%(h))
	print("""%s \33[m[02] \33[1;32mNew id Alamgir """%(h))
	print("""%s ════════════════════════════════════════════════════════ """%(h))
	...
	print("""%s ════════════════════════════════════════════════════════ """%(h))
	aplik = input(x+'\33[m[ ? ] \33[1;32m•Alamgir Api Key ? (y/t):  ')
	if aplik in ['y','Y']:
		taplikasi.append('ya')
	else:
		taplikasi.append('no')
	osk = input(x+'\33[m[ ? ] \33[1;33m•Alamgir checkpoint id show ? (y/t):  ')
	if osk in ['y','Y']:
		oprek.append('ya')
	else:
		oprek.append('no')
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [Alamgir] %s/%s ~_~ [OK:%s] ^_^ [CP:%s] ~_~ %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
