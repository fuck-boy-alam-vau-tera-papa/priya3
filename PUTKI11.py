...
print("\033[0;92mThis Tool's Free By Md Alamgir Hosen")
...
def menu():
    ...
    print'FB OLD ID CLONING-[FUCK BOY ALAMGIR]'

    print 50* '-'

    print '\033[0;92mCodder   : FUCK BOY ALAMGIR'

    print '\033[0;91mAUTHOR   : FUCK BOY ALAMGIR'

    print '\033[0;93mFACEBOOK : https://m.me/Tera.Papa.Alamgir.441'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;91m[ALAMGIR-CP]\x1b[1;92m ' + k + c + user + ' | ' + pass1 + '\x1b[0m \n'
